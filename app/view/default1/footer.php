...
<footer id="footer">
    <span>
            Tüm hakları saklıdır ve <a href="http://metin2.test/index">Zahira2</a> mülkiyetindedir.</span>
</footer>
            ...
            <form action="<?= site_url('login') ?>" method="post" accept-charset="utf-8">
                ...
                <div class="login-box-row">
                    ...
                    <div class="login-box-options">
                        <a href="<?= site_url('forgot-password') ?>" data-hasevent="1">Şifremi Unuttum?</a><br>
                        <a href="<?= site_url('forgot-username') ?>" data-hasevent="1">Hesap Adımı Unuttum?</a><br>
                    </div>
                </div>
                <div class="clear"></div>
            </form>
