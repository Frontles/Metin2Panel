    ...
    if ($password == false) {
        ...
        if ($getPassword <= 0) {
            ...
            if ($now <= $tDate) {
                ...
                $link = site_url('profile-ksk-response?str=' . $arg . '&token=' . $token);
                ...
                sendmail(settings('settings_gamename') . " Karakter Silme Şifresi Değişikliği", $getMail, $text);
                ...
                setplayerlog( '8', "karakter silme için $getMail adresine mail gönderildi");

                $result['result']= True;
                $result['message']= 'Karakter Silme Şifresi Değişim isteğiniz Epostanıza iletildi..';
