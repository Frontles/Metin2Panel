var FormEditable = function () {
    ...
    var a = function (a, e) {
        ...
        $.mockjax({
            ...
            url: "/groups", response: function (e) {
                this.responseText = [{value: 0, text: "Guest"}, {value: 1, text: "Service"}, {
                    value: 2,
                    text: "Customer"
                }, {value: 3, text: "Operator"}, {value: 4, text: "Support"}, {value: 5, text: "Admin"}], a(e, this)
            }
        })
    }, i = function () {
        "inline" == App.getURLParameter("mode") ? ($.fn.editable.defaults.mode = "inline", $("#inline").attr("checked", !0)) : $("#inline").attr("checked", !1), $.fn.editable.defaults.inputclass = "form-control", $.fn.editable.defaults.url = "/post",
            $("#username").editable({
            url: "/post",
            type: "text",
            pk: 1,
            ...
            display: function (a, e) {
                var i = {"": "gray", 1: "green", 2: "blue"}, n = $.grep(e, function (e) {
                    return e.value == a
                });
                n.length ? $(this).text(n[0].text).css("color", i[a]) : $(this).empty()
            }
        }), $("#status").editable(), $("#group").editable({showbuttons: !1}), $("#vacation").editable({rtl: App.isRTL()}), $("#dob").editable({inputclass: "form-control"}), $("#event").editable({
            ...
            validate: function (a) {
                return a && 10 == a.getDate() ? "Day cant be 10!" : void 0
            },
            datetimepicker: {rtl: App.isRTL(), todayBtn: "linked", weekStart: 1}
        }), $("#comments").editable({showbuttons: "bottom"}), $("#note").editable({showbuttons: App.isRTL() ? "left" : "right"}), $("#pencil").click(function (a) {
            a.stopPropagation(), a.preventDefault(), $("#note").editable("toggle")
        }), $("#state").editable({source: ["Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Mississippi", "Missouri", "Montana", "Nebraska", "Nevada", "New Hampshire", "New Jersey", "New Mexico", "New York", "North Dakota", "North Carolina", "Ohio", "Oklahoma", "Oregon", "Pennsylvania", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Utah", "Vermont", "Virginia", "Washington", "West Virginia", "Wisconsin", "Wyoming"]}), $("#fruits").editable({
            pk: 1,
            limit: 3,
        ...
        $.each({
            ...
            url: "/post",
            value: {city: "San Francisco", street: "Valencia", building: "#24"},
            validate: function (a) {
                return "" == a.city ? "city is required!" : void 0
            },
            display: function (a) {
                if (!a)return void $(this).empty();
    ...
    return {
        init: function () {
            e(), i(), $("#enable").click(function () {
                $("#user .editable").editable("toggleDisabled")
            }), $("#inline").on("change", function (a) {
                $(this).is(":checked") ? window.location.href = "form_editable.html?mode=inline" : window.location.href = "form_editable.html"
            }), $("#user .editable").on("hidden", function (a, e) {
                if ("save" === e || "nochange" === e) {
                    var i = $(this).closest("tr").next().find(".editable");
