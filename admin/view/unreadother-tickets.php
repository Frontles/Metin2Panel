        ...
        <div class="">
            ...
            <center>
                <div class="row" style="margin: 10px;">
                    <div class="col-md-12">
                        ...
                        <a href="<?=admin_url('readother-tickets')?>" class="btn btn-primary text-center">
                            Diğer Yöneticilere  Ait Ticketlar (Yanıtlanmış)
                        </a>
                    </div>
                </div>
            </center>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Diğer Yöneticilere Ait Yanıtlanmamış  Ticketlar  <small>
                                </small></h2>
                            <div align="right">
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php  foreach($tickets as $ticket) :$say++;
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $ticket['title'] ?></td>
                                        <td><?= $message ?></td>
                                        <td> <?=$ticket['whoname'] == null ? '<span class="label label-sm label-danger">  Yönetici Atanmadı </span>' :'<span class="label label-sm label-primary"> ' . $ticket['whoname'] . ' </span>'  ?> </td>
