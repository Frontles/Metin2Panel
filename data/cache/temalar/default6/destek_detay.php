												...
												<div class="inner-form-border">
													<div class="inner-form-box">
														<form id="registerForm" accept-charset="UTF-8" action="" method="POST">
															...
															<?php echo form_textarea(['name'=>'mesaj', 'value'=>null, 'class'=>'form-control', 'cols'=>'40', 'rows'=>'10', 'placeholder'=>'Cevabınızı buraya yazınız', 'style'=>'width:calc(100% - 20px); margin-top:10px;']);?>
															<br>
															<button type="submit" style="font-weight: bold;  font-size: 13px; padding: 0px 0px;">&emsp;&emsp;&emsp;&emsp;&emsp;CEVAPLA&emsp;&emsp;&emsp;&emsp;&emsp;</button>
														</form>
													</div>
												</div>
											</form>
