                    ...
                    <div id="character-info">
                        <table>
                            <tbody>
								...
								<tr>
									<td><div><br><br><ul><li><a href="<?php echo base_url('karakter_silme_kodu_degistir');?>"><p style="margin-top: -31px;">Karakter Silme Kodu Değiştir</p></a>Hesabınızda bulunan 20. seviye üstü karakterleri silip yeni bir yer açmak için gereken koddur.<br/>&nbsp;</li></ul></div></td>
