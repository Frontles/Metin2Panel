...
<div class="col-md-4">
<?php if($this->config->item('nemere') == true):?>
<ul class="list-group">
...
<div class="col-md-4">
<?php if($this->config->item('razador') == true):?>
<ul class="list-group">
