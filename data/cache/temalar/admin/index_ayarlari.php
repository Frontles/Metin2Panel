...
<br>
						...
						<div class="form-group">
							<?php echo form_label('Video Embed Url (URL sonu eklenmelidir. örnek link https://www.youtube.com/watch?v=<font color="red">QigNM_UgjUA</font> )<small class="text-danger float-right">'.form_error('videolink').'</small>', 'videolink', ['style'=>'width: 100%;']);?>
