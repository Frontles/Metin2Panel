				...
				<div class="card-body">
					<div class="invoice-head">
						<div class="row">
							<div class="iv-left col-12">
								<span>Market Haber Oluştur</span>
							</div>
						</div>
					</div>
					<form action="" method="post" class="ajax-form-json">
						...
						<div class="form-group">
							...
							<?php echo form_input('resim', null, ['class'=>'form-control', 'autocomplete'=>'off']);?>
						</div>

						<div class="form-group">
							<?php echo form_label('Haber Başlığı<small class="text-danger float-right">'.form_error('baslik').'</small>', 'baslik', ['style'=>'width: 100%;']);?>
						...
						<div class="form-group">
							...
							<?php echo form_input('metin', null, ['class'=>'form-control', 'autocomplete'=>'off']);?>
						</div>
