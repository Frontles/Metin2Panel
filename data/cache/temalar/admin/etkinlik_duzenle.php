				...
				<div class="card-body">
					...
					<form action="" method="post" class="ajax-form-json">
						...
						<div class="form-group">
							...
							<?php echo form_dropdown('etkinlik', $this->model->enum_degerleri('etkinlikler','etkinlik',true), $row->etkinlik, ['class'=>'form-control', 'autocomplete'=>'off'])?>
						</div>
						...
						<div class="form-group">
							...
							<input name="baslangicTarihi" class="form-control" type="datetime-local" value="<?php echo strftime('%Y-%m-%dT%H:%M:00', strtotime($row->baslangicTarihi));?>">
						</div>
						...
						<div class="form-group">
							...
							<input name="bitisTarihi" class="form-control" type="datetime-local" value="<?php echo strftime('%Y-%m-%dT%H:%M:00', strtotime($row->bitisTarihi));?>">
						</div>
						<div class="form-group">
							<?php echo form_label('Tekrarlayan Etkinlik<small class="text-danger float-right">'.form_error('tekrarlayan').'</small>', 'tekrarlayan', ['style'=>'width: 100%;']);?>
