	...
	<div class="row">
		<div class="col-12 mt-5">
                                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                                            <strong>Eşya ekleme</strong> Eklenen eşyalara kaç adet taş basılıyor ise EFSUN VE TAŞLAR sekmesinden taş slotunu aktif taş slotu olarak ayarlanmalıdır. (Örn : Eşyaya 3 taş basılıyor ise Slot#3 e kadar aktif taş slotu seçilir)
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active" id="genel" role="tabpanel" aria-labelledby="genel-tab">
								...
								<div class="form-group">
									...
									<?php echo form_input('isim', item_ad_cevir($item->locale_name), ['class'=>'form-control', 'autocomplete'=>'off'])?>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-6">
											...
											<?php echo form_input('cash', set_value('cash'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-6">
											<?php echo form_label('Değeri (1 birim miktari içerisinde kaç adet eşya olacağını yazınız. En az 1 olmalıdır.)<small class="text-danger float-right">'.form_error('deger').'</small>', 'deger', ['style'=>'width: 100%;']);?>
											<?php echo form_input('deger', set_value('deger',1), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-6">
											...
											<?php echo form_input('adet_1', set_value('adet_1',1), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-6">
											<?php echo form_label('İndirim (%)<small class="text-danger float-right">'.form_error('indirim_1').'</small>', 'indirim_1', ['style'=>'width: 100%;']);?>
											<?php echo form_input('indirim_1', set_value('indirim_1',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-6">
											...
											<?php echo form_input('adet_2', set_value('adet_2',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-6">
											<?php echo form_label('İndirim (%)<small class="text-danger float-right">'.form_error('indirim_2').'</small>', 'indirim_2', ['style'=>'width: 100%;']);?>
											<?php echo form_input('indirim_2', set_value('indirim_2',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-6">
											...
											<?php echo form_input('adet_3', set_value('adet_3',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-6">
											<?php echo form_label('İndirim (%)<small class="text-danger float-right">'.form_error('indirim_3').'</small>', 'indirim_3', ['style'=>'width: 100%;']);?>
											<?php echo form_input('indirim_3', set_value('indirim_3',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-6">
											...
											<?php echo form_input('adet_4', set_value('adet_4',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-6">
											<?php echo form_label('İndirim (%)<small class="text-danger float-right">'.form_error('indirim_4').'</small>', 'indirim_4', ['style'=>'width: 100%;']);?>
											<?php echo form_input('indirim_4', set_value('indirim_4',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-6">
											...
											<?php echo form_input('adet_5', set_value('adet_5',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-6">
											<?php echo form_label('İndirim (%)<small class="text-danger float-right">'.form_error('indirim_5').'</small>', 'indirim_5', ['style'=>'width: 100%;']);?>
											<?php echo form_input('indirim_5', set_value('indirim_5',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<?php echo form_dropdown('KID', $this->model->dropdown_urun_kategoriler(), set_value('KID'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
								</div>

								<div class="form-group">
									<?php echo form_label('Durumu<small class="text-danger float-right">'.form_error('durum').'</small>', 'durum', ['style'=>'width: 100%;']);?>
									<?php echo form_dropdown('durum', [1=>'Aktif', 0=>'Pasif', 2=>'EM Market'], set_value('durum'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
								</div>
							<div class="row">
							<div class="col-4">
								<div class="form-group">
									...
									<div class="form-check">
										<?php echo form_checkbox('sureli', false, false, ['class'=>'form-check-input', 'id'=>'sureli'])?>
										<label class="form-check-label" for="sureli">Ekleyeceğiniz eşya süreli ise bunu işaretleyiniz !</label>									
									</div>
								</div></div>
								<div class="col-4">
								<div class="form-group">
									<?php echo form_label('Süreli Eşya Sorunu<small class="text-danger float-right">'.form_error('surelisorunu').'</small>', 'surelisorunu', ['style'=>'width: 100%;']);?>
									<div class="form-check">
										<?php echo form_checkbox('surelisorunu', false, false, ['class'=>'form-check-input', 'id'=>'surelisorunu'])?>
										<label class="form-check-label" for="surelisorunu">Eklediğiniz eşyada kaybolma sorunu var ise işaretleyiniz !</label>									
									</div>
								</div></div>
								<div class="col-4">
								<div class="form-group">
									...
									<div class="form-check">
										<?php echo form_checkbox('efsun', false, false, ['class'=>'form-check-input', 'id'=>'efsun'])?>
										<label class="form-check-label" for="efsun">Oyuncuların eşyayı alırken efsun seçmesini istiyorsanız seçin.</label>									
									</div>
								</div></div></div>
					<br><br>
								<div class="form-group">
									<div class="row">
										<div class="col-4">
											...
											<?php echo form_input('gun', set_value('gun', 0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-4">
											<?php echo form_label('Süre (Saat)<small class="text-danger float-right">'.form_error('saat').'</small>', 'saat', ['style'=>'width: 100%;']);?>
											<?php echo form_input('saat', set_value('saat', 0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
										<div class="col-4">
											<?php echo form_label('Süre (Dakika)<small class="text-danger float-right">'.form_error('dakika').'</small>', 'dakika', ['style'=>'width: 100%;']);?>
											<?php echo form_input('dakika', set_value('dakika', 0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="form-check">
										...
										<div class="col-4">
											...
											<?php echo form_input('valueoran', set_value('valueoran', 0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
										</div>
								</div>
							</div>
								<div class="form-group">
									...
									<?php echo form_textarea(['name'=>'aciklama', 'value'=>set_value('aciklama'), 'class'=>'form-control', 'cols'=>'40', 'rows'=>'3']);?>
								</div>

								<div class="form-group">
									<?php echo form_label('Eşya Bilgisi<small class="text-danger float-right">'.form_error('bilgi').'</small>', 'bilgi', ['style'=>'width: 100%;']);?>
									<?php echo form_textarea(['name'=>'bilgi', 'value'=>set_value('bilgi'), 'class'=>'form-control', 'cols'=>'40', 'rows'=>'3']);?>
								</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-6">
												...
												<?php echo form_dropdown('attrtype0', $this->model->dropdown_item_attrtype(), set_value('attrtype0'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
											<div class="col-6">
												<?php echo form_label('Türü #1<small class="text-danger float-right">'.form_error('attrvalue0').'</small>', 'attrvalue0', ['style'=>'width: 100%;']);?>
												<?php echo form_input('attrvalue0', set_value('attrvalue0',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-6">
												...
												<?php echo form_dropdown('attrtype1', $this->model->dropdown_item_attrtype(), set_value('attrtype1'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
											<div class="col-6">
												<?php echo form_label('Türü #2<small class="text-danger float-right">'.form_error('attrvalue1').'</small>', 'attrvalue1', ['style'=>'width: 100%;']);?>
												<?php echo form_input('attrvalue1', set_value('attrvalue1',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-6">
												...
												<?php echo form_dropdown('attrtype2', $this->model->dropdown_item_attrtype(), set_value('attrtype2'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
											<div class="col-6">
												<?php echo form_label('Türü #3<small class="text-danger float-right">'.form_error('attrvalue2').'</small>', 'attrvalue2', ['style'=>'width: 100%;']);?>
												<?php echo form_input('attrvalue2', set_value('attrvalue2',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-6">
												...
												<?php echo form_dropdown('attrtype3', $this->model->dropdown_item_attrtype(), set_value('attrtype3'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
											<div class="col-6">
												<?php echo form_label('Türü #4<small class="text-danger float-right">'.form_error('attrvalue3').'</small>', 'attrvalue3', ['style'=>'width: 100%;']);?>
												<?php echo form_input('attrvalue3', set_value('attrvalue3',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-6">
												...
												<?php echo form_dropdown('attrtype4', $this->model->dropdown_item_attrtype(), set_value('attrtype4'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
											<div class="col-6">
												<?php echo form_label('Türü #5<small class="text-danger float-right">'.form_error('attrvalue4').'</small>', 'attrvalue4', ['style'=>'width: 100%;']);?>
												<?php echo form_input('attrvalue4', set_value('attrvalue4',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-6">
												...
												<?php echo form_dropdown('attrtype5', $this->model->dropdown_item_attrtype(), set_value('attrtype5'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
											<div class="col-6">
												<?php echo form_label('Türü #6<small class="text-danger float-right">'.form_error('attrvalue5').'</small>', 'attrvalue5', ['style'=>'width: 100%;']);?>
												<?php echo form_input('attrvalue5', set_value('attrvalue5',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-6">
												...
												<?php echo form_dropdown('attrtype6', $this->model->dropdown_item_attrtype(), set_value('attrtype6'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
											<div class="col-6">
												<?php echo form_label('Türü #7<small class="text-danger float-right">'.form_error('attrvalue6').'</small>', 'attrvalue6', ['style'=>'width: 100%;']);?>
												<?php echo form_input('attrvalue6', set_value('attrvalue6',0), ['class'=>'form-control', 'autocomplete'=>'off'])?>
											</div>
										</div>
									</div>
									<div class="form-group">
										<?php echo form_label('Slot #1<small class="text-danger float-right">'.form_error('socket0').'</small>', 'socket0', ['style'=>'width: 100%;']);?>
										<?php echo form_dropdown('socket0', $this->model->dropdown_item_socket(), set_value('socket0'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
									</div>
									<div class="form-group">
										<?php echo form_label('Slot #2<small class="text-danger float-right">'.form_error('socket1').'</small>', 'socket1', ['style'=>'width: 100%;']);?>
										<?php echo form_dropdown('socket1', $this->model->dropdown_item_socket(), set_value('socket1'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
									</div>
									<div class="form-group">
										<?php echo form_label('Slot #3<small class="text-danger float-right">'.form_error('socket2').'</small>', 'socket2', ['style'=>'width: 100%;']);?>
										<?php echo form_dropdown('socket2', $this->model->dropdown_item_socket(), set_value('socket2'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
									</div>
									<div class="form-group">
										<?php echo form_label('Slot #4<small class="text-danger float-right">'.form_error('socket3').'</small>', 'socket3', ['style'=>'width: 100%;']);?>
										<?php echo form_dropdown('socket3', $this->model->dropdown_item_socket(), set_value('socket3'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
									</div>
									<div class="form-group">
										<?php echo form_label('Slot #5<small class="text-danger float-right">'.form_error('socket4').'</small>', 'socket4', ['style'=>'width: 100%;']);?>
										<?php echo form_dropdown('socket4', $this->model->dropdown_item_socket(), set_value('socket4'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
									</div>
									<div class="form-group">
										<?php echo form_label('Slot #6<small class="text-danger float-right">'.form_error('socket5').'</small>', 'socket5', ['style'=>'width: 100%;']);?>
										<?php echo form_dropdown('socket5', $this->model->dropdown_item_socket(), set_value('socket5'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
									</div>
									<div class="form-group">
										<?php echo form_label('Slot #7<small class="text-danger float-right">'.form_error('socket6').'</small>', 'socket6', ['style'=>'width: 100%;']);?>
										<?php echo form_dropdown('socket6', $this->model->dropdown_item_socket(), set_value('socket6'), ['class'=>'form-control', 'autocomplete'=>'off'])?>
									</div>
								</div>
							</div>
						</div>
