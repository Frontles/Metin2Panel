				...
				<div class="card-body">
					...
					<form action="" method="post" class="ajax-form-json">
						...
						<div class="form-group">
							...
							<?php echo form_input('isim', set_value('isim',$row->isim), ['class'=>'form-control', 'autocomplete'=>'off'])?>
						</div>

						<div class="form-group">
							<?php echo form_label('Eposta<small class="text-danger float-right">'.form_error('eposta').'</small>', 'eposta', ['style'=>'width: 100%;']);?>
							<?php echo form_input('eposta', set_value('eposta',$row->eposta), ['class'=>'form-control', 'autocomplete'=>'off'])?>
						</div>

						<div class="form-group">
							<?php echo form_label('Yetki<small class="text-danger float-right">'.form_error('yetki').'</small>', 'yetki', ['style'=>'width: 100%;']);?>
							<?php echo form_dropdown('yetki', [1=>'Yönetici', 2=>'Talep Ekibi' , 3=>'Ban ve Talep Ekibi'], $row->yetki, ['class'=>'form-control', 'autocomplete'=>'off'])?>
						</div>
