				...
				<div class="card-body">
					...
					<form action="" method="post" class="ajax-form-json">
						...
						<div class="form-group">
							...
							<?php echo form_input('boyut', $row->boyut, ['class'=>'form-control', 'autocomplete'=>'off']);?>
						</div>

						<div class="form-group">
							<?php echo form_label('Paket Linki<small class="text-danger float-right">'.form_error('link').'</small>', 'link', ['style'=>'width: 100%;']);?>
							<?php echo form_input('link', $row->link, ['class'=>'form-control', 'autocomplete'=>'off']);?>
						</div>
