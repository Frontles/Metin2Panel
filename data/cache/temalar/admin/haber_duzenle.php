				...
				<div class="card-body">
					...
					<form action="" method="post" class="ajax-form-json">
						...
						<div class="form-group">
							...
							<?php echo form_input('resim', $row->resim, ['class'=>'form-control', 'autocomplete'=>'off', 'placeholder'=>'http://']);?>
						</div>
						...
						<div class="form-group">
							...
							<?php echo form_textarea(['name'=>'metaDesc', 'value'=>$row->metaDesc, 'class'=>'form-control', 'cols'=>'40', 'rows'=>'3', 'autocomplete'=>'off']);?>
						</div>

						<div class="form-group">
							<?php echo form_label('İçerik <small class="text-danger float-right">'.form_error('icerik').'</small>', 'icerik', ['style'=>'width: 100%;']);?>
							<?php echo form_textarea(['name'=>'icerik', 'value'=>$row->icerik, 'class'=>'form-control mail-taslak-ck', 'cols'=>'40', 'rows'=>'7', 'autocomplete'=>'off']);?>
						</div>
