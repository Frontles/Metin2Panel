		...
		<center>
			<div id="content_center">
				<div class="box-style1" style="margin-bottom:55px;">
					...
					<ul class="tabrow">
						<li class="selected">
							<a href="<?php echo base_url('sifremi_unuttum');?>">Hesap Şifreni Sıfırla</a>
						</li>
					</ul>
					<h2 class="title"></h2>
					<div class="entry">
							...
							<form action="" autocomplete="off" method="post" class="ajax-form-json register-form">
								...
								<table>
									<tbody>
										...
										<tr>
											<td>
												<br><button type="submit" style=" width: 260px; font-weight: bold; font-size: 13px; padding: 12px 0px;">&emsp;&emsp;&emsp;&emsp;&emsp;Pin Kodumu Sıfırla&emsp;&emsp;&emsp;&emsp;<i class="read-more"></i></button></br>
											</td>
										</tr>
										</center>
									</tbody>
