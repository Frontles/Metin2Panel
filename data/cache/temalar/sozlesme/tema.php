...
<table width="520" align="center" cellspacing="0" cellpadding="0">
	<tr>
		<td>
		<center><br>Oyunumuza kayıt olan her oyuncu, aşağıda belirtilen maddeleri kabul etmiş sayılmaktadır. Lütfen oyuncu sözleşmenizi dikkatlice okuyup, onaylamadan kayıt olmayınız !</center>
		<br/><br/>	<b><u>Üyelik ve Hizmet Sözleşmesi</u></b><br/><br/>
			<table>
				...
				<tr>
					...
					<td>Destek sistemine gönderilen sahte video ve benzeri unsurlar için tarafların başlatacağı hukuki işlemlerde <a href="<?php echo base_url('site');?>" target="_blank"><?php echo $this->config->item('site_title');?></a> yönetimi sorumlu değildir.Sorumluluk, öğeyi gönderen oyuncu ve kapatılan oyuncunundur</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>Eğer herhangi bir oyun açığı tespit eder ve bunu rapor etmek isterseniz : <a href="<?php echo base_url('destek');?>" target="_blank"><?php echo $this->config->item('site_title');?> - Destek Sistemi</a>ne gönderebilirsiniz.</td>
				</tr>
				...
				<tr>
					...
					<td>Hesap paylaşımı yasak değildir. Hesap paylaşımı sonucunda oluşacak sorunlardan <?php echo $this->config->item('site_title');?> Yönetimi sorumlu değildir.</td>
				</tr>
				...
				<tr>
					...
					<td><a href="<?php echo base_url('site');?>" target="_blank"><?php echo $this->config->item('site_title');?></a> dışı hesap ve item satışları, takasları yasaktır.</td>
				</tr>
	...
	<tr>
				...
				<tr>
					...
					<td>Oyun içerisinde, oyuncular arası ilişkiler sonucu gerçek hayatta ortaya çıkabilecek hiçbir olaydan <a href="<?php echo base_url('site');?>" target="_blank"><?php echo $this->config->item('site_title');?></a> Yönetimi sorumlu tutulamaz. </td>
				</tr>
				...
				<tr>
					...
					<td>Oyun içerisinde bulunan bütün hesaplar <?php echo $this->config->item('site_title');?> yönetimine aittir. Yönetim gerekli gördüğü takdirde hesapları kapatabilir, değişiklik yapabilir.</td>
				</tr>
...
<a href="<?php echo base_url('site');?>" target="_blank"><?php echo $this->config->item('site_title');?></a> Yönetimi, Üyelik ve Hizmet Sözleşmesi'nde belirtilen maddeleri değiştirme hakkını gizli tutar.<br />
<br /><br />
	</tr>
		</table>
		<br/>
