...
<link href="/temalar/default7/css/reset.css" rel="stylesheet">
<link href="/temalar/default7/css/style.css" rel="stylesheet">
<link href="/temalar/default7/css/global.css" rel="stylesheet">
<link href="/temalar/default7/css/util.css" rel="stylesheet">
<link href="/temalar/default7/css/small-page.css" rel="stylesheet">
<link href="/temalar/default7/css/animate.min.css" rel="stylesheet">
<link href="/temalar/default7/lib/fancybox3/jquery.fancybox.min.css" rel="stylesheet">
<link href="/temalar/default7/fonts/fontawesome/fontawesome-combined.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="/temalar/default7/uyari/sweetalert.css">
...
<script src="/temalar/default7/js/slider.js"></script>
<script src="/temalar/default7/js/modalx.js"></script>
...
<a href="#" data-izimodal-open="#modal" data-izimodal-transitionin="fadeInDown" class="shop">
&nbsp;
</a>
			<?php if(!isset($this->account->id)):?>
...
<?php endif;?>
<a href="<?php echo $this->config->item('link_facebook');?>" class="facebook" target="_blank">
&nbsp;
</a>
</div>
</div>
...
<img src="/temalar/default7/images/slider/v14slider.jpg" alt="">
<div>
...
<div class="slide">
<img src="/temalar/default7/images/slider/acilis_tarihi.jpg" alt="">
...
<img src="/temalar/default7/images/slider/2.jpg" alt="">
<div>
<a href="#" target="_blank">Haberler</a>
...
<img src="/temalar/default7/images/slider/1.jpg" alt="">
<div>
<a href="#" target="_blank">Haberler</a>
...
<?php $this->load->view('default7/'.$sayfa);?>
...
<?php if(!isset($this->account)): ?>
								...
								<div class="login-block-b">
									<form class="login-form block-p ajax-form-json" name="loginForm" accept-charset="UTF-8" action="<?php echo base_url('giris');?>" method="post">
									<?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash()); ?>
										<input type="hidden" name="_token" value="jbJ9yozAJW6S15qGWjaAGK2HbWIcitCIecO4ka9u">
										<div class="login-title">
											<span>VEYA <i class="far fa-arrow-right"></i>&nbsp;&nbsp;<a href="index.php?GoPage=GetRegister">KAYIT OL</a></span>GİRİŞ YAP
										</div>
...
<?php endif;?>
							<?php if($this->config->item('recaptcha_durum') == TRUE): ?>
								<div class="g-recaptcha" data-sitekey="<?php echo html_entity_decode(htmlspecialchars_decode(@$this->config->item('recaptcha_sitekey'),ENT_QUOTES),ENT_QUOTES,'UTF-8');?>" style="-webkit-transform: scale(0.7);-webkit-transform-origin: 0 0;"></div>
							<?php endif; ?>
										<button class="login-button button-n" type="submit" data-theme="dark">GİRİŞ YAP</button>
										<a href="<?php echo base_url('sifremi_unuttum');?>" class="lost-pass">Parolamı unuttum.</a>
																			</form>
...
<br>
			...
			<!-- Bu veri önbellekten gösterilmektedir. --> 
						...
						<? if($key == 0)
							echo ($i = '<img src="/temalar/default7/images/highscore/1.png"/>');
						else if($key == 1)
							echo ($i = '<img src="/temalar/default7/images/highscore/2.png"/>');
						else if($key == 2)
							echo ($i = '<img src="/temalar/default7/images/highscore/3.png"/>');
						else
							echo ($key+1);
						?></td></td>		
								<td class="hidden-xs"><img src="/temalar/default7/assets/images/empire_flag_<?php echo $oyuncu->empire;?>.png" width="32" height="15"/></td>
