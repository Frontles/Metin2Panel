			...
			<div id="content_center">
				<div class="box-style1" style="margin-bottom:55px;">
					<div class="entry">
						...
						<ul class="tabrow">
							<li class="selected">
								<a href="<?php echo base_url('destek_olustur');?>" class="top-up-btn gold-a">Yeni Destek Talebi Oluştur</a>
							</li>
						</ul>
						<h2 class="title"></h2>
						<?php endif; ?>
							...
							<table class="ranking-table" cellpadding="0" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="<?php echo base_url('destek_detay/'.$destek->DID);?>" class="top-up-btn gold-a">Detay</a></td>
									</tr>
									<?php endforeach; ?>
								</tbody>
							</table>
