			...
			<div class="card">
				<div class="card-body">
					...
					<form action="/admin/site_ayarlari_sitelogo" method="post" enctype="multipart/form-data" class="ajax-form-json">
						<?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash()); ?>
						<div class="form-group">
							<?php echo form_label('Site Logosu (png veya jpg formatında olmalıdır.)<small class="text-danger float-right">'.form_error('sitelogo').'</small>', 'sitelogo', ['style'=>'width: 100%;']);?>
							<div class="row">
								<div class="col-7">
