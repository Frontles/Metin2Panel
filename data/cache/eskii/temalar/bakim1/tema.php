...
<html lang='en' class=''>
  ...
  <body>
    <video autoplay loop muted poster="https://i.hizliresim.com/YdnjbE.jpg" id="background">
</video>
    <div class="main">
      <div id='content'>
        <div class='title'>
          <span><?php echo $this->config->item('site_title');?></span>
        </div><br><br>
        <p>Websitemiz yapım aşamasındadır.</p><br><br>
        <p>İlginiz için <a href="#" target="_blank">teşekkür </a>ederiz!</p>
      </div>
    </div>
    <script src='http://mintik.com/jQuery/jquery-1.10.2.min.js'></script>
  </body>
