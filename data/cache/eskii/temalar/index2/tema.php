...
<link href="/temalar/index2/css/bootstrap.min.css" rel="stylesheet">
<link href="/temalar/index2/css/Arones2.css" rel="stylesheet">
<link href="/temalar/index2/css/slick.css" rel="stylesheet">
<link href="/temalar/index2/css/slick-theme.css" rel="stylesheet">
<meta name="msapplication-TileColor" content="#c5a1a0">
<link href="https://fonts.googleapis.com/css?family=Play:700" rel="stylesheet">
<script src="/temalar/index2/js/main2.js"></script>
<script src="/temalar/index2/js/slick.min.js"></script>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><font color="black">Lucifer (Düşebilecek İtemler)</h4>
        </div>
  ...
  <div class="modal fade" id="myModalbarones" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><font color="black">Barones (Düşebilecek İtemler)</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="myModalcatacomb" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><font color="black">Catacomb (Düşebilecek İtemler)</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="myModalejder" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><font color="black">Beran Setaou (Düşebilecek İtemler)</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="myModalhidra" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><font color="black">Hidra (Düşebilecek İtemler)</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="myModalmeley" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><font color="black">Meley (Düşebilecek İtemler)</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="myModalnemere" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><font color="black">Nemere (Düşebilecek İtemler)</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="myModalrazador" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><font color="black">Razador (Düşebilecek İtemler)</h4>
        </div>
        <div class="modal-body">
...
body {
    width: 100%;
    background: url(<?php echo $this->config->item('arkaplan');?>) center top no-repeat, url() center bottom no-repeat;
...
<div class="top-panel flex-c-c">
		<ul class="menu">
			<li><a href="<?php echo $this->config->item('anasayfa');?>">Anasayfa</a></li>
			<li><a href="<?php echo $this->config->item('indir');?>">İNDİR</a></li>
			<li><a href="<?php echo $this->config->item('kayit');?>">KAYDOL</a></li>
...
<center style="
    font-size: 23px;
"><?php echo $this->config->item('acilis');?></center><br> 
</div>
<div class="row">
<div class="col-md-12">
<div class="panel panel-default">
<center><div class="panel-heading">OYUNA BAŞLANGIÇ</div></center><br>

<div><a data-fancybox="gallery" href="<?php echo $this->db->get('tanitim_baslangic')->row('resim');?>"><img src="<?php echo $this->db->get('tanitim_baslangic')->row('resim');?>" alt=""></a></div>
</div>

<div class="DungeonInfo">
<?php if($maddeler = $this->model->getir_maddeler(5)) foreach ($maddeler as $key => $madde):?>
<?php if($madde->maddeler > '0'):?>
<div>
<center><h3><?php echo $madde->maddeler;?></h3></center>
</div>
<?php endif;?>
<?php endforeach;?>
...
<div class="panel panel-default">
<div class="panel-heading"><center>Sosyal Medya</center></div><br>
<div class="panel-body">
<center><iframe src="https://www.facebook.com/plugins/likebox.php?href=<?php echo $this->config->item('link_facebook');?>&amp;width=470&amp;height=590&amp;colorscheme=dark&amp;show_faces=false&amp;header=false&amp;stream=true&amp;show_border=false&amp;appId=245938138842990" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:470px; height:590px;" allowTransparency="true"></iframe>
</center><div style="clear:both;"></div><br>
</div>
</div>
</div>
<?php endif;?>
<div class="panel panel-default">
<div class="panel-heading"><center>Biyolog - Süreleri</center></div><br>
<div class="panel-body">
<p><center>
<div class="col-md-6">
<ul class="list-group">
...
<div class="panel panel-default">
<div class="panel-heading"><center>Efsun Oranları</center></div><br>
<div class="panel-body">
...
<div class="panel panel-default">
<div class="panel-heading"><center>Bosslar</center></div><br>
<div class="panel-body">
<div class="col-md-4">
<ul class="list-group">
...
<div class="panel panel-default">
<div class="panel-heading"><center>Dönüşüm</center></div><br>
<div class="panel-body">
<center>
...
<div class="panel panel-default">
<div class="panel-heading"><center><?php echo $liste->baslik;?></center></div><br>
<div><a data-fancybox="gallery" href="<?php echo $liste->resim;?>"><img src="<?php echo $liste->resim;?>" alt=""></a></div><br>
<div class="panel-body">
<h5><center><p>
					<?php if($liste->madde1 > '0'):?>
					<font face="tahoma" size="2"><li><?php echo $liste->madde1; ?></li></font>
					<?php endif;?>
					<?php if($liste->madde2 > '0'):?>
					<font face="tahoma" size="2"><li><?php echo $liste->madde2; ?></li></font>
					<?php endif;?>
					<?php if($liste->madde3 > '0'):?>
					<font face="tahoma" size="2"><li><?php echo $liste->madde3; ?></li></font>
					<?php endif;?>
					<?php if($liste->madde4 > '0'):?>
					<font face="tahoma" size="2"><li><?php echo $liste->madde4; ?></li></font>
					<?php endif;?>
					<?php if($liste->madde5 > '0'):?>
					<font face="tahoma" size="2"><li><?php echo $liste->madde5; ?></li></font>
					<?php endif;?>
</p></center></h5>
<div style="clear:both;"></div><br>
</div>
...
Tüm hakları saklıdır. © <?php echo $this->config->item('site_title');?>.<br>
</div>
<br><br><br><br><br><br>
</div>
...
#duyuru-alt {
    ...
    border-top: 2px solid #a18d5a;
    background: url(/temalar/index2/img/duyuru.jpg) no-repeat;
}
#duyuru-alt h4 {
    margin: 0;
    margin-top: 11px;
...
<div id="duyuru-alt">
<center>
<h4><?php echo $this->config->item('acilis');?></h4>
<span><?php echo $this->config->item('altacilis');?></span><br>
</center>
</div>
<br><br><br><br><br>
</head>
  ...
  <div class="text-center" id="top">
    <img class="text-center" src="/temalar/index2/img/top.png" />
    <br>
