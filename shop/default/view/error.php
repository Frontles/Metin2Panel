...
<head>
    ...
    <!--[if IE 8]>
    <link rel="stylesheet" href="a<?= shop_public_url('app/public/shop/css/ie-8-3.css') ?>" type="text/css" />
    <![endif]-->
    ...
    <!--[if lt IE 8]>
    <script type="text/javascript" src="<?= shop_public_url('app/public/shop/css/ie-8-8.css') ?>"></script>
    <![endif]-->
    <!--[if lt IE 9]>
    <script type="text/javascript" src="<?= shop_public_url('app/public/shop/css/ie-8-9.css') ?>"></script>
    <![endif]-->
...
<div id="page" class="row-fluid">
    <div id="header" class="header clearfix">
        <div class="span5">
            <h1>
                <a style="background: url(<?=URL. '/'.settings('settings_logo')?>) 0 50% no-repeat;background-size: contain;"><?=settings('settings_gamename')?></a>
            </h1>
        </div>
    </div><!-- header -->
            ...
            <div id="error" class="contrast-box">
                <div class="dark-grey-box">
                    ...
                    <ul class="clearfix" style="list-style: disc">
                        ...
                        <li style="margin-top: 5px;">Hesabınıza giriş yapmadan nesne markete girmeye çalışıyor olabilirsiniz.</li>
                        <li style="margin-top: 5px;">Hesabınıza ait oyunda bir karakter açmadan nesne markete girmeye çalışıyor olabilirsiniz.</li>
                    </ul>
