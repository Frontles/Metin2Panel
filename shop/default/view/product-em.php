<?php
    $menu = product_em()['menu'];
    $items = product_em()['items'];
    $count = count($items);
                                ...
                                <div class="contrast-box  item-box inner-content clearfix">
                                    <div class="desc row-fluid">
                                        <div class="item-description">
                                            ...
                                            <h4 class="fancybox fancybox.ajax" href="<?=shop_url('product-ajaxem?id='.$val['item_id'].'&token='.$itemToken)?>">
                                                <a class="card-heading" title="<?=$val['item_name']?>">
                                                    <?=$val['item_name']?>
                                                </a>
                                            </h4>
                                            <div class="item-shortdesc clearfix">
                                                <a class="item-thumb fancybox fancybox.ajax" href="<?=shop_url('product-ajaxem?id='.$val['item_id'].'&token='.$itemToken)?>">
                                                ...
                                                <div class="fancybox fancybox.ajax" href="<?=shop_url('product-ajaxem?id='.$val['item_id'].'&token='.$itemToken)?>">
                                        ...
                                        <div class="item-footer price_desc row-fluid js_currency_default">
                                            ...
                                            <div class="action-box right">
                                                ...
                                                <button class="span5 right btn-buy fancybox fancybox.ajax" href="<?=shop_url('product-ajaxem?id='.$val['item_id'].'&token='.$itemToken)?>">Satın al</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
